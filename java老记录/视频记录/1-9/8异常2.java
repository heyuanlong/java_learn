...
*/
class FuShuIndexException extends Exception//如果继承的是RuntimeException。则函数上不用进行声明
{
	FuShuIndexException()
	{}
...
class Demo
{
	public int method(int[] arr,int index)throws FuShuIndexException//Exception子类对象异常必须在这里声明一下
	{		
...
{
	public static void main(String[] args)throws FuShuIndexException//Exception子类对象异常必须在这里声明一下
	{
		int[] arr = new int[3];
